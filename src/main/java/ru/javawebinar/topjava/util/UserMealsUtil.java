...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExceed> getFilteredWithExceeded(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        return mealList.stream()
                ...
                .map(meal -> new UserMealWithExceed(meal.getDateTime(), meal.getDescription(), meal.getCalories(), allCaloriesByDay.get(meal.getDateTime().toLocalDate()) > caloriesPerDay))
        ...
        for (UserMeal userMeal : mealList) {
            ...
            allCaloriesByDay.merge(currentDate, userMeal.getCalories(), Integer::sum);
        }
        ...
        for (UserMeal userMeal : mealList) {
            ...
            if (TimeUtil.isBetween(mealListTime, startTime, endTime))
            {
                result.add(new UserMealWithExceed(userMeal.getDateTime(), userMeal.getDescription(), userMeal.getCalories(), allCaloriesByDay.get(userMeal.getDateTime().toLocalDate()) > caloriesPerDay));
            }
